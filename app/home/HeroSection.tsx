      ...
      <div className="relative w-full overflow-hidden bg-[#061551] pt-12 px-6 md:px-14 lg:px-18 pb-5 md:pb-0">
        <div className="relative w-full overflow-hidden rounded-4xl">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center px-4 py-12 md:py-20 mt-5 md:mt-0 text-center text-[#DFE1E4]">
            <h1 className="mb-4 text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl lg:text-5xl">Increase Visibility.</h1>
            <h1 className="mb-4 text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl lg:text-5xl">Strengthen Sales. Predict</h1>
            <h1 className="mb-4 text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl lg:text-5xl">Demand. Built in</h1>
            <h1 className="mb-4 text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl lg:text-5xl">Collaboration with Major</h1>
            <h1 className="mb-4 text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl lg:text-5xl">FMCG Players.</h1>

            <div className="mt-6 mb-8">
              <p className="max-w-2xl text-md text-gray-200 sm:text-xl">Sales Watch is a sales rep monitoring solution developed by SSS</p>
              <p className="max-w-2xl text-md text-gray-200 sm:text-xl">(Software System Solutions), designed to empower distributors and</p>
              <p className="max-w-2xl text-md text-gray-200 sm:text-xl">companies with control over their sales teams in the field.</p>
            </div>
            ...
            <div className="flex gap-4 mt-0 mb-9">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center px-6 pt-12 pb-8 md:py-20 text-center text-[#DFE1E4]">
          <div className="flex justify-start gap-2 md:gap-6 lg:gap-20 text-start">
            <div>
              <h1 className="mb-4 text-2xl font-bold tracking-tight sm:text-4xl md:text-5xl lg:text-6xl">500+</h1>
              <p className="font-normal text-sm md:text-md lg:text-base">Sales Activities Tracked</p>
            </div>

            <div>
              <h1 className="mb-4 text-2xl font-bold tracking-tight sm:text-4xl md:text-5xl lg:text-6xl">50+</h1>
              <p className="font-normal text-sm md:text-md lg:text-base">Verified Sales Visits</p>
            </div>

            <div>
              <h1 className="mb-4 text-2xl font-bold tracking-tight sm:text-4xl md:text-5xl lg:text-6xl">100+</h1>
              <p className="font-normal text-sm md:text-md lg:text-base">Companies Using</p>
            </div>

            <div>
              <h1 className="mb-4 text-2xl font-bold tracking-tight sm:text-4xl md:text-5xl lg:text-6xl">97%+</h1>
              <p className="font-normal text-sm md:text-md lg:text-base">Customer Satisfaction</p>
            </div>
          </div>
        </div>
      </div>
